export default class TBDatePicker extends HTMLElement {
  constructor() {
    super();
  ...
  set value( value ) {
    this._data = value === null ? null : new Date( value.getTime() );
  }
...
window.customElements.define( 'tb-date-picker', TBDatePicker );
