export default class TBTextArea extends HTMLElement {
  constructor() {
    super();
  ...
  _render() {
    this.$input.textContent = this.value === null ? '' : this.value;
...
window.customElements.define( 'tb-text-area', TBTextArea );
